...
// Specify the contract address of the contract
const contractAddress = '0x27e69a1acd722A0aA02F4bf611Ea797bFC4Ba3Ee';
// Specify the contract call address and the default call private key
...
describe('RandomOracleConsumer', function () {
  ...
  it.skip('RandomOracleConsumer:Request random number emit', async function () {
    ...
    //testnet random number cost test, 1 random number cost is about 0.2373U
    //compute method:
    //each random number cost:0.025 LINK+0.00008 BNB
    //with 1LINK=8.5U  1BNB=310U
