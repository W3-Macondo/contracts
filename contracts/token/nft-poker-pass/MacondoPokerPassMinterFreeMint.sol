...
contract MacondoPokerPassMinterFreeMint is
    Initializable,
    PausableUpgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function _saleBefore(
        ...
        //Limit each address to purchase only once
    ...
    //freeMint
    function freeMint(address _to, bytes memory signature)
        external
        payable
        nonReentrant
    {
        ...
        address signer = recoverSigner(
            keccak256(abi.encodePacked(to, currentNonce)),
            signature
        );
